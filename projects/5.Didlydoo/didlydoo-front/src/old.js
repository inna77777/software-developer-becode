...
function createEventDOM(event, availabilitiesGridNumIndex) {
  ...
  event.dates.forEach((date) => {
    ...
    falseAvBtn.classList.add("avBtn", "redAv"); // Initially red
    falseAvBtn.textContent = "✘"; // "X"

    // Handle the click event on the checkmark
    trueAvBtn.addEventListener("click", () => {
      // Set the checkmark button to green
      trueAvBtn.classList.add("greenAv");
      trueAvBtn.classList.remove("grayAv"); // Remove gray when clicked

      // Set the "X" button to gray
      falseAvBtn.classList.add("grayAv");
      falseAvBtn.classList.remove("redAv"); // Remove red when clicked

      // Ensure the "X" button has its text
      falseAvBtn.textContent = "✘";
    });

    // Handle the click event on the "X"
    falseAvBtn.addEventListener("click", () => {
      // Set the "X" button to red
      falseAvBtn.classList.add("redAv");
      falseAvBtn.classList.remove("grayAv"); // Remove gray when clicked

      // Set the checkmark button to gray
      trueAvBtn.classList.add("grayAv");
      trueAvBtn.classList.remove("greenAv"); // Remove green when clicked

      // Ensure the checkmark button has its text
